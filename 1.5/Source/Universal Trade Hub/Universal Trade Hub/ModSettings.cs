...
namespace Universal_Trade_Hub
{
	public class UTH_ModSettings : ModSettings
	{
		...
		public float wealthMultiplier = 0.05f;
		public float baseSubscriptionPrice = 1000;

		public float attackChance = 0.02f;

		public float specialMultiplier = 2.8f;
		...
		public override void ExposeData()
		{
			...
			Scribe_Values.Look(ref wealthMultiplier, "wealthMultiplier", 0.05f);
			...
			Scribe_Values.Look(ref specialMultiplier, "specialMultiplier", 2.8f);
	...
	public class UTH_Mod : Mod
	{
		...
		private void DrawOrder_Settings(Listing_Standard listingStandard, Rect settingsAreaRect)
		{
			...
			settings.expressDeliveryMultiplierPerKg = Widgets.HorizontalSlider(sliderRect3, settings.expressDeliveryMultiplierPerKg, 0f, 5.0f, true, "UTH_ExpressDeliveryMultiplierPerKgLabel".Translate() + ": " + settings.expressDeliveryMultiplierPerKg.ToString("P0"), "0%", "500%");
			...
			settings.insuranceMultiplier = Widgets.HorizontalSlider(sliderRect6, settings.insuranceMultiplier, 0f, 5.0f, true, "UTH_InsuranceMultiplierLabel".Translate() + ": " + settings.insuranceMultiplier.ToString("P0"), "0%", "500%");
			TooltipHandler.TipRegion(sliderRect6, "UTH_InsuranceMultiplierTooltip".Translate());

			innerListing.Gap(25f);

			Rect sliderRect7 = innerListing.GetRect(22f);
			settings.deliveryTimePerKg = Widgets.HorizontalSlider(sliderRect7, settings.deliveryTimePerKg, 0f, 5.0f, true, "UTH_DeliveryTimePerKgLabel".Translate() + ": " + settings.deliveryTimePerKg.ToString("P0"), "0%", "500%");
			TooltipHandler.TipRegion(sliderRect7, "UTH_DeliveryTimePerKgTooltip".Translate());

			innerListing.Gap(25f);

			Rect sliderRect8 = innerListing.GetRect(22f);
			settings.deliveryTimeReductionForStuff = Widgets.HorizontalSlider(sliderRect8, settings.deliveryTimeReductionForStuff, 0f, 5.0f, true, "UTH_DeliveryTimeReductionForStuffLabel".Translate() + ": " + settings.deliveryTimeReductionForStuff.ToString("P0"), "0%", "500%");
			...
			settings.priceReductionMultiplier = Widgets.HorizontalSlider(sliderRect9, settings.priceReductionMultiplier, 0f, 5.0f, true, "UTH_PriceReductionMultiplierLabel".Translate() + ": " + settings.priceReductionMultiplier.ToString("P0"), "0%", "500%");
			...
			settings.wealthMultiplier = Widgets.HorizontalSlider(sliderRect10, settings.wealthMultiplier, 0f, 5.0f, true, "UTH_WealthMultiplierLabel".Translate() + ": " + settings.wealthMultiplier.ToString("P0"), "0%", "500%");
			...
			settings.attackChance = Widgets.HorizontalSlider(sliderRect12, settings.attackChance, 0f, 1.0f, true, "UTH_AttackChanceLabel".Translate() + ": " + settings.attackChance.ToString("P0"), "0%", "100%");
			TooltipHandler.TipRegion(sliderRect12, "UTH_AttackChanceTooltip".Translate());

			innerListing.Gap(25f);

			Rect sliderRect13 = innerListing.GetRect(22f);
			settings.specialMultiplier = Widgets.HorizontalSlider(sliderRect13, settings.specialMultiplier, 0f, 5.0f, true, "UTH_SpecialMultiplierLabel".Translate() + ": " + settings.specialMultiplier.ToString("P0"), "0%", "500%");
			TooltipHandler.TipRegion(sliderRect13, "UTH_SpecialMultiplierTooltip".Translate());
		...
		private void ResetToDefaults()
		{
			...
			settings.wealthMultiplier = 0.05f;
			settings.baseSubscriptionPrice = 1000;

			settings.attackChance = 0.02f;

			settings.specialMultiplier = 2.8f;
		}
	}
}
